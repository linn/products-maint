...
export const saCoreTypes = new ItemType(
    'saCoreTypes',
    'SA_CORE_TYPES',
    '/products/maint/sa-core-types'
);
...
export const TariffsReallocate = new ItemType(
    'tariffsReallocate',
    'TARIFFS_REALLOCATE',
...
export const oldTariffs = new ItemType('oldTariffs', 'OLD_TARIFFS', '/products/maint/tariffs');
