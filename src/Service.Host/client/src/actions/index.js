...
export const salesArticlesReallocateActionTypes = makeActionTypes(
...
export const oldTariffsActionTypes = makeActionTypes(itemTypes.oldTariffs.actionType, false);
