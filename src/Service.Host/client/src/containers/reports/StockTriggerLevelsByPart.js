...
const getPartNumber = ownProps => {
    return ownProps.match.params.partNumber;
}
...
export default connect(mapStateToProps, mapDispatchToProps)(initialiseOnMount(StockTriggerLevelsByPart));