namespace Linn.Products.Service.Tests.WeeeReportModuleSpecs
{
    ...
    public class WhenGettingGermanyWeeeReport : ContextBase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            this.WeeeReportsService.GetGermanWeeeReport(Arg.Any<DateTime>(), Arg.Any<DateTime>())
        ...
        {
            this.WeeeReportsService.Received().GetGermanWeeeReport(Arg.Any<DateTime>(), Arg.Any<DateTime>());
        }
